...
document.addEventListener('DOMContentLoaded', function() {
  openPopup();
  dragElement(document.getElementById("cta-popup"));
});
...
function dragElement(elmnt) {
  ...
  if (elmnt.querySelector(".cta-header")) {
      elmnt.querySelector(".cta-header").onmousedown = dragMouseDown;
  } else {
  ...
  function elementDrag(e) {
      ...
      // Atur posisi elemen tanpa mengubah ukuran
